...
0
|| checktplrefresh('./template/default/home/space_album_list.htm', './template/default/home/space_header.htm', 1436236897, 'diy', './data/template/1_diy_home_space_album_list.tpl.php', './template/default', 'home/space_album_list')
|| checktplrefresh('./template/default/home/space_album_list.htm', './template/default/common/userabout.htm', 1436236897, 'diy', './data/template/1_diy_home_space_album_list.tpl.php', './template/default', 'home/space_album_list')
|| checktplrefresh('./template/default/home/space_album_list.htm', './template/default/home/space_userabout.htm', 1436236897, 'diy', './data/template/1_diy_home_space_album_list.tpl.php', './template/default', 'home/space_album_list')
|| checktplrefresh('./template/default/home/space_album_list.htm', './template/default/common/header_common.htm', 1436236897, 'diy', './data/template/1_diy_home_space_album_list.tpl.php', './template/default', 'home/space_album_list')
|| checktplrefresh('./template/default/home/space_album_list.htm', './template/default/home/space_diy.htm', 1436236897, 'diy', './data/template/1_diy_home_space_album_list.tpl.php', './template/default', 'home/space_album_list')
|| checktplrefresh('./template/default/home/space_album_list.htm', './template/default/home/space_header_personalnv.htm', 1436236897, 'diy', './data/template/1_diy_home_space_album_list.tpl.php', './template/default', 'home/space_album_list')
;?>
<?php $friendsname = array(1 => '仅好友可见',2 => '指定好友可见',3 => '仅自己可见',4 => '凭密码可见');?><?php if($diymode) { if($_G['setting']['homepagestyle']) { $_G[cookie][extstyle] = false;?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=album&amp;view=me&amp;from=space">相册</a>
</div>
</div>
...
<div class="tbmu cl">
<?php if(helper_access::check_module('album') && $space['self'] && (($diymode && !$_G['setting']['homepagestyle']) || (!$diymode && !$_G['setting']['homestyle']))) { ?><a href="home.php?mod=spacecp&amp;ac=upload" class="y pn pnc"><strong>上传图片</strong></a><?php } if($space['self'] && $_GET['view']=='me') { ?>
...
<a href="home.php?mod=space&amp;do=album&amp;view=all" <?php if(!$_GET['catid']) { ?><?php echo $orderactives['dateline'];?><?php } ?>>最近更新的相册</a><span class="pipe">|</span>
...
<p class="xg1"><a href="home.php?mod=spacecp&amp;ac=album&amp;op=editpic&amp;albumid=<?php echo $value['albumid'];?>">编辑</a> <a href="home.php?mod=spacecp&amp;ac=upload&amp;albumid=<?php echo $value['albumid'];?>">上传</a>
</p>
<?php } else { ?>
...
<p class="ptn xi2"><a href="home.php?mod=space&amp;uid=<?php echo $value['uid'];?>&amp;do=album&amp;id=-1">默认相册</a></p>
</li>
<?php } ?>
</ul>
