...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1436238304, '1', './data/template/1_1_common_header_forum_modcp.tpl.php', './template/default', 'common/header_forum_modcp')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1436238304, '1', './data/template/1_1_common_header_forum_modcp.tpl.php', './template/default', 'common/header_forum_modcp')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1436238304, '1', './data/template/1_1_common_header_forum_modcp.tpl.php', './template/default', 'common/header_forum_modcp')
;?>
