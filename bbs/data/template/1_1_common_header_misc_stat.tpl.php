...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1436237065, '1', './data/template/1_1_common_header_misc_stat.tpl.php', './template/default', 'common/header_misc_stat')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1436237065, '1', './data/template/1_1_common_header_misc_stat.tpl.php', './template/default', 'common/header_misc_stat')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1436237065, '1', './data/template/1_1_common_header_misc_stat.tpl.php', './template/default', 'common/header_misc_stat')
;?>
